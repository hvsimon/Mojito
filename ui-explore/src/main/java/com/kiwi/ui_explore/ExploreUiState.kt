...
data class IBACategoryItemUiState(
    ...
    val imageUrl: String = when (type) {
        IBACategoryType.THE_UNFORGETTABLES ->
            "https://images.unsplash.com/" +
                ...
                "&fit=crop" +
                "&w=2148&q=80"
        IBACategoryType.CONTEMPORARY_CLASSICS ->
            "https://images.unsplash.com/" +
                ...
                "&w=2375" +
                "&q=80"
        IBACategoryType.NEW_ERA_DRINKS ->
            "https://images.unsplash.com/" +
